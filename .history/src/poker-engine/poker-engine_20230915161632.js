str_has = function (comparison) { //String.prototype.
    if (this.indexOf(comparison) < 0) {return false}
    return true
};
haskey = function(item=false) { //Object.prototype.
    if (item == false) {return false}
    if (item in this) {return true}
    return false
};
shuffleArr = function () { //Array.prototype.
    let new_arr=[]
    for (var i=1; i <=5 ;i++) {
...
arr_has = function (comparison) { //Array.prototype.
    if (this.indexOf(comparison) < 0) {return false}
    return true
};
