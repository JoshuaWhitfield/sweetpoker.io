    ...
    <div>
      <Form className='basic-card mx-auto'>
        <FormGroup>
          ...
          />
          {errors.validEmail && <div className='flex jcc' style={{height: '5px', marginTop: '-5px'}}><p className="error-message">invalid email format!</p></div>}
        </FormGroup>
        <FormGroup>
          <Input
        ...
        <div className='flex dir-row jcc mt-3'>
          <Link className='styled-link' to={'/'}><p className='light-text link-text'>forgot password</p></Link>
            <HorizontalSpacing width='35px' />
          <Link className='styled-link' to={'/'}><p className='light-text link-text'>create account</p></Link>
        </div>
        <br />
      </Form>
    </div>
