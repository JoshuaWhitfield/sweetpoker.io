    ...
    <div>
      <Form className='basic-card mx-auto'>
        ...
        <div className='flex dir-row jcc mt-3'>
          <Link className='styled-link link-text light-text'><p className='light-text'>forgot password</p></Link>
            <HorizontalSpacing width='35px' />
          <Link className='styled-link link-text'><p className='light-text'>create account</p></Link>
        </div>
        <br />
      </Form>
    </div>
