...
const Header = () => {
    ...
    return (
        <>
            <div className='container container-fluid dep'>
                <div className='center-content' style={{height: '80px', width: 'fit-content'}}>
                    ...
                    <Col className='col-3 center-content offset-2 full-height' style={{justifyContent: 'end'}}><Button path={'/top-up'} target={'blank_'} name={'Top Up'} width='110px' /></Col>
                </div>
            </div>
        </>
    );
